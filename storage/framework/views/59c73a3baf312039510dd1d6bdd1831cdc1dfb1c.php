...
<nav class="side-navbar shrink">
    ...
    <ul id="side-main-menu" class="side-menu list-unstyled">
        ...
        <li><a href="<?php echo e(url('public/read_me')); ?>"> <i class="dripicons-information"></i><span><?php echo e(trans('file.Documentation')); ?></span></a></li>
        <?php endif; ?>
    </ul>
</nav>
...
<?php echo $__env->make('backend.layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/modernmiller/resources/views/backend/sale/pos.blade.php ENDPATH**/ ?>