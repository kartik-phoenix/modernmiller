                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Daily Sale Objective')); ?></strong> </label>
                                        <input type="number" name="daily_sale_objective" class="form-control" step="any" value="<?php echo e($lims_product_data->daily_sale_objective); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        <?php if($lims_product_data->is_embeded): ?>
                                ...
                                <div class="col-md-12 mt-3" id="variant-option">
                                    ...
                                    <h5 class="d-none"><input name="is_variant" type="checkbox" id="is-variant" value="1" checked>&nbsp; <?php echo e(trans('file.This product has variant')); ?></h5>
                                    <?php else: ?>
                                ...
                                <div class="col-md-12" id="variant-section">
                                    ...
                                    <div class="row" id="variant-input-section">
                                        ...
                                        <div class="col-md-4 form-group mt-2">
                                            ...
                                            <input type="text" name="variant_option[]" class="form-control variant-field" value="<?php echo e($lims_product_data->variant_option[$key]); ?>">
                                        </div>
                                        <div class="col-md-6 form-group mt-2">
                                            <label><?php echo e(trans('file.Value')); ?> *</label>
                                            <input type="text" name="variant_value[]" class="type-variant form-control variant-field" value="<?php echo e($lims_product_data->variant_value[$key]); ?>">
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="table-responsive ml-2">
                                        <table id="variant-table" class="table table-hover variant-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e($variant->name); ?>

                                                        <input type="hidden" class="form-control variant-name" name="variant_name[]" value="<?php echo e($variant->name); ?>" />
                                                    </td>
                                                    <td><input type="text" class="form-control" name="item_code[]" value="<?php echo e($variant->pivot['item_code']); ?>" /></td>
                                                    <td><input type="number" class="form-control additional-cost" name="additional_cost[]" value="<?php echo e($variant->pivot['additional_cost']); ?>" step="any" /></td>
                                                    <td><input type="number" class="form-control additional-price" name="additional_price[]" value="<?php echo e($variant->pivot['additional_price']); ?>" step="any" /></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
                                        </table>
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/modernmiller/resources/views/backend/product/edit.blade.php ENDPATH**/ ?>