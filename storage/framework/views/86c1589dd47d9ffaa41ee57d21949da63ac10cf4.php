...
<html dir="<?php if( Config::get('app.locale') == 'ar' || $general_setting->is_rtl): ?><?php echo e('rtl'); ?><?php endif; ?>">
  ...
  <body <?php if($theme == 'dark'): ?> class="dark-mode dripicons-brightness-low" <?php else: ?> class="" <?php endif; ?> onload="myFunction()">
    <div id="loader"></div>
      <!-- Side Navbar -->
    ...
    <div class="page">
      ...
      <header class="container-fluid">
        <nav class="navbar">
            ...
            <?php endif; ?>
            <?php if($product_qty_alert_active && ($alert_product + $dso_alert_product_no + count(\Auth::user()->unreadNotifications)) > 0): ?>
                <li class="nav-item" id="notification-icon">
                    <a rel="nofollow" data-toggle="tooltip" title="<?php echo e(__('Notifications')); ?>" class="nav-link dropdown-item"><i class="dripicons-bell"></i><span class="badge badge-danger notification-number"><?php echo e($alert_product + $dso_alert_product_no + count(\Auth::user()->unreadNotifications)); ?></span>
                    </a>
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <span class="external"><?php echo e($general_setting->developed_by); ?></span> | V 3.8</p>
            </div>
          </div>
        </div>
      </footer>
...
<?php /**PATH /var/www/html/modernmiller/resources/views/backend/layout/main.blade.php ENDPATH**/ ?>